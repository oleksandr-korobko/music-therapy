...
import hlushchenko from '../assets/img/team/02_Hlushchenko_2.jpg';
import korh from '../assets/img/team/03_Korh_2.png';
import malashevska from '../assets/img/team/04_Malashevska_2.jpg';
import marchenkoValeriia from '../assets/img/team/05_Marchenko_Valeriia_2.jpg';
import marchenkoMariia from '../assets/img/team/06_Marchenko_Mariia_2.jpg';
...
import yazvinska from '../assets/img/team/10_Yazvinska.jpg';
...
const experts = [
  ...
  {
    name: 'Людмила Глущенко',
    role: 'Заслужений працівник культури',
    imageUrl: hlushchenko,
    description: 'Заслужений працівник культури, автор-пісняр, практикуючий психолог.'
  },
  {
    name: 'Віра Корх',
    role: 'Кандидатка психологічних наук',
    imageUrl: korh,
    description: 'Психолог, викладач психології у вузі, кандидат психологічних наук. Старший викладач кафедри психології і педагогіки Київського національного лінгвістичного університету.'
  },
  {
    name: 'Валерія Марченко',
    role: 'Концертмейстер',
    imageUrl: marchenkoValeriia,
    description: 'Концертмейстер, викладач Київської муніципальної академії музики імені Р. Глієра, учасниця музичних гуртів "The Heavenly River" та "Atmawinds".'
  },
  {
    name: 'Марія Марченко',
    role: 'Кандидатка мистецтвознавства',
    imageUrl: marchenkoMariia,
    description: 'Кандидатка мистецтвознавства, диригентка хору Kamerton та A Tempo, вокалістка гуртів AARO, Atmawinds, The Heavenly river, авторка методики роботи з голосом "Вокальна йога".'
  },
  {
    name: 'Ірина Язвинська',
    role: 'Артистка оркестру',
    imageUrl: yazvinska,
    description: 'Артистка оркестру Сумського національного академіного театру драми та муз. комедії ім. М.С.Щепкіна.'
  }
];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg leading-8 text-gray-600">
            Команда висококваліфікованих фахівців у сфері музикотерапії
          </p>
        </div>
        <ul
          role="list"
        ...
        >
          {experts.map((person) => (
            <li key={person.name} className="group">
              <img
                className="aspect-[3/3] w-full rounded-2xl object-cover transition-transform duration-500 group-hover:scale-105"
                src={person.imageUrl}
                alt={person.name}
              />
